...
public class XHtmlSerializer<T extends IPrintWriter> implements INodeVisitor<T> {
	...
	public static String serialize(final IElement e, final boolean noemptytag) {
		return XHtmlSerializer.serialize("", "    ", noemptytag, e);
	}
