...
/** Standard web application with IWickletApplication and IGwtAjaxSupportProvider. */
public abstract class GwtWebApplication extends WebApplication implements IWickletApplication, IGwtAjaxSupportProvider {
	public static GwtWebApplication get() {
		return (GwtWebApplication)WebApplication.get();
	}
